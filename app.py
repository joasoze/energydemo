...
UI_TITLE = os.environ.get("UI_TITLE") or "Copilot for Energy (experimental)"
UI_LOGO = os.environ.get("UI_LOGO") or "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Microsoft_icon.svg/1024px-Microsoft_icon.svg.png"
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO") or "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Microsoft_icon.svg/1024px-Microsoft_icon.svg.png"
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Welcome to Copilot for Energy!"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Open-source datasets from Azure Data Manager for Energy and the Norwegian Offshore Directorate."
UI_FAVICON = os.environ.get("UI_FAVICON") or "/favicon.ico"
UI_SHOW_SHARE_BUTTON = "false"#os.environ.get("UI_SHOW_SHARE_BUTTON", "true").lower() == "false"
...
AZURE_OPENAI_SYSTEM_MESSAGE = os.environ.get("AZURE_OPENAI_SYSTEM_MESSAGE", "You are an AI assistant that helps users find data. If you get questions about Wells and Wellbores then show information about those wells. Dont show depth information based on ids")
...
def should_use_data():
    ...
    if AZURE_SEARCH_SERVICE and AZURE_SEARCH_INDEX:
        ...
        print("Using Azure Cognitive Search")
        return True
...
def prepare_model_args(request_body):
    ...
    if SHOULD_USE_DATA:
        #print("get_configured_data_source:", get_configured_data_source())
        #print("dominik")
        model_args["extra_body"] = {
            "dataSources": [get_configured_data_source()]
        }
    #print("Model Args:", model_args)  # Print statement added
    #print("Conor")
    model_args_clean = copy.deepcopy(model_args)
    #print("Model Args:", model_args_clean)  # Print statement added
    #print("Diaz")
